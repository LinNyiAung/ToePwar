  ...
  Future<Transaction> addTransaction({
    ...
    try {
      final response = await http.post(
        Uri.parse('${ApiConstants.baseUrl}/addtransactions'), // Updated endpoint
        headers: {
  ...
  Future<Transaction> editTransaction({
    ...
    try {
      final response = await http.put(
        Uri.parse('${ApiConstants.baseUrl}/edittransactions/$id'), // Updated endpoint
        headers: {
          'Authorization': 'Bearer $token',
          'Content-Type': 'application/json',
        },
  ...
  Future<void> deleteTransaction(String id) async {
    try {
      final response = await http.delete(
        Uri.parse('${ApiConstants.baseUrl}/deletetransactions/$id'), // Updated endpoint
        headers: {'Authorization': 'Bearer $token'},
      );
