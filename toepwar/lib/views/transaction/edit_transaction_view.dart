          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 8),
                _buildExamplePhrase('💰 "1000 salary January 15"'),
                _buildExamplePhrase('🛒 "50 groceries yesterday"'),
                _buildExamplePhrase('🚗 "30 taxi 3 days ago"'),
                _buildExamplePhrase('🍽️ "100 dining out today"'),
              ],
            ),
          ),
        ],
