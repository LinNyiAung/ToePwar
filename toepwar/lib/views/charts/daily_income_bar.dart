  ...
  Future<void> _fetchDailyIncomes() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // Transform daily totals to DailyIncome objects
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 20),
              Text('No income data available for selected month'),
            ],
          ),
        ),
      );
                        ...
                        getTitlesWidget: (value, meta) {
                          if (value >= 0 && value < _dailyIncomes.length) {
                            return Padding(
                              ...
                              child: Text(
                                _formatDate(_dailyIncomes[value.toInt()].date),
                    ...
                    return BarChartGroupData(
                      ...
                      barRods: [
                        BarChartRodData(
                          ...
                          color: Colors.green, // Use green to differentiate from expenses
                          width: 22,
