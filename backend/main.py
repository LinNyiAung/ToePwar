...
from routes import admin_routes, auth_routes, budget_plan_routes, user_routes, transaction_routes, goal_routes, dashboard_routes, report_routes, ai_routes, chart_routes
